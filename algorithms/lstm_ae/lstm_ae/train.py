...
def main(params):
    ...
    """
    model_url, dls, num_feats, latent_seq_len, latent_num_feats, hidden_size, num_layers, dropout, batch_size, seq_len, loss, epochs, patience, lr, optimizer, scheduler = params.values()
