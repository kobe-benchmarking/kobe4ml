...
def main(dir, name, process, train_size, infer_size, norm_include, time_include, shifted, splitted, sorted, weighted, analyzed, normalized, weights_from, stats_from):
    """
